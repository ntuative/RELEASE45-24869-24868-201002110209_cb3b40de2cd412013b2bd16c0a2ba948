package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_849 = new Array();
         var_30 = param1.id;
         var_1219 = param1.nextState;
         var_1284 = param1.loop;
         if(param1.background != null)
         {
            var_847 = getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(var_1284 == true || var_690 == 0)
         {
            if(false)
            {
               ++var_46;
               if(var_46 >= var_848.length)
               {
                  var_46 = 0;
                  ++var_690;
               }
      ...
      {
         return var_1284 == false && var_690 == 1 && var_1219 != var_30;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_847 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_847.width),Math.max(param2.height,var_847.height));
            _loc3_.copyPixels(var_847,var_847.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_46 <= var_849.length)
         {
            _loc2_ = var_849[var_46];
