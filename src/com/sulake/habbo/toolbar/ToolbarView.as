package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_174 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_38,HabboWindowStyle.const_854,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_926 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_926)
         {
         ...
         var_1112 = _loc7_.toolbar.@margin_bottom;
         var_1372 = _loc7_.toolbar.@min_group_margin;
         var_1373 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_237,param1,param2,_window,var_254);
         createGroupsFromXmlList(_loc9_,var_523,param1,param2,var_174,var_254);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_113,var_424,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1372,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1112) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1372,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1112) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_113,var_424);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_424);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_113,var_424);
         }
      }
