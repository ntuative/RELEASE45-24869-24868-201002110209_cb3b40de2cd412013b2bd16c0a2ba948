package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_723:int = 50;
      
      private static const const_1015:Number = 25;
      
      private static const const_1016:int = 50;
      
      private static const const_161:Boolean = true;
       
      
      private var var_517:Timer;
      
      private var var_921:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_921 = param2;
         var_517 = new Timer(const_1015);
         var_517.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_421.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_421.splice(_loc3_,1);
            var_422.splice(_loc3_,1);
         }
         var_422.push(param1.name);
         var_421.push(param2);
         param1.addEventListener(WindowEvent.const_419,windowEventListener);
         param1.addEventListener(WindowEvent.const_203,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_421[var_422.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_921.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            name_1[_loc3_.menuId] = _loc3_;
            var_274.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_274.indexOf(param1) > -1)
         {
            if(const_161)
            {
               name_1[param1].active = false;
               name_1[param1].window = null;
            }
            else
            {
               name_1[param1] = null;
               var_274.splice(var_274.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_921.getIconLoc(param1.iconId);
      ...
      {
         return var_422[var_421.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_274[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_516[_loc3_] = new Array();
            }
            if(var_516[_loc3_].indexOf(param1) < 0)
            {
               var_516[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_723 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_723 || param1.desktop.height - param1.y < const_1016;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_422[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_516[_loc3_].length)
                  {
                     repositionWindow(var_516[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
