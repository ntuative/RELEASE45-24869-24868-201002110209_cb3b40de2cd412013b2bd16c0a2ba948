package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_158:HabboHotelView;
      ...
      private var var_1833:PseudoRandom;
      ...
      private const const_1399:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_297:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1835)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1166,var_1834));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1399,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1833);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1399,"/");
      ...
      {
         var_638 = _habboConfiguration.getKey("sso.ticket",null);
         var_1166 = _habboConfiguration.getKey("flash.client.url","");
         var_1834 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_158 == null)
         {
            var_158 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_638 != null)
         {
            var_63.mode = HabboConnectionType.const_399;
            var_63.initConnection(HabboConnectionType.const_235);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_489);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1833 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_399:
               _loc6_ = "";
               ...
               var_963 = _loc4_;
               var_158.loadBannerImage(_loc7_ + "?token=" + var_963,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1205:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1340:
               var_962 = generateRandomHexString(30);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_158.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_963);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_150,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_82,onRoomSessionEnded);
      }
