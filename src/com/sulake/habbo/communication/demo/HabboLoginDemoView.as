package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_313:HabboCommunicationDemo;
      ...
      {
         var_313.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_313.shockwaveClientUrl = var_104.shockwaveClientUrl;
         var_313.ssoTicket = var_104.ticket;
         var_104.removeEventListener(SSOTicket.const_270,onParsedTicketSuccess);
         var_104.removeEventListener(SSOTicket.const_252,onParsedTicketFailure);
         var_104 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1399,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_313 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_313.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_409,HabboWindowStyle.const_23,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_313.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1399,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_313.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_313.habboCommunication.habboWebLogin(name,password);
         var_104 = new SSOTicket(var_313.assets,_loc2_,_loc1_);
         var_104.addEventListener(SSOTicket.const_270,onParsedTicketSuccess);
         var_104.addEventListener(SSOTicket.const_252,onParsedTicketFailure);
      }
