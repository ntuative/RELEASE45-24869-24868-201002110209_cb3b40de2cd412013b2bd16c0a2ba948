package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_395:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1005:int = -1;
      
      private var var_1243:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1243 = new LagWarningLogger();
         var_1242 = new Array(const_749);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1209,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1157,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_889,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_489:
               trackLoginStep(HabboLoginTrackingStep.const_1338,String(_communication.port));
               break;
      ...
      {
         var_75 = IHabboCatalog(param2) as IHabboCatalog;
         var_75.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_75.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_75.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_163)
         {
            Component(var_163).events.addEventListener(HabboConfigurationEvent.const_150,onConfigurationLoaded);
            if(var_217 != null)
            {
               var_217.configuration = var_163;
            }
            if(var_218 != null)
            {
               var_218.configuration = var_163;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_427.events.addEventListener(AdEvent.const_391,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2014)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1290);
            var_2014 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_889,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_489,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_593,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_348:
               var_1243.registerWarning(LagWarningLogger.const_887);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_427)
            {
               var_427.release(new IIDHabboAdManager());
               var_427 = null;
            }
            if(_navigator)
            {
            ...
            if(var_75)
            {
               if(true)
               {
                  var_75.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_75.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_75.release(new IIDHabboCatalog());
               var_75 = null;
            }
            if(var_8)
            {
            ...
            if(var_162)
            {
               if(true)
               {
                  ...
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.const_298,onFriendlistTrackingEvent);
               }
            ...
            if(var_395)
            {
               if(true)
               {
                  var_395.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_395.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_395.release(new IIDHabboHelp());
               var_395 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_348,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_163)
         {
            Component(var_163).events.removeEventListener(HabboConfigurationEvent.const_150,onConfigurationLoaded);
         }
      }
      ...
      {
         var_395 = param2 as IHabboHelp;
         var_395.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_395.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_844);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_844,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1485;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1485);
         }
         if(var_1005 > -1 && _loc2_ - var_1005 > 15000)
         {
            ++var_1484;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1484);
         }
         var_1005 = _loc2_;
         if(var_218 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_348,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_216,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.const_298,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_593)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1169);
         }
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1341);
         }
      }
   }
}
