package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_774:Number = 0;
      
      private var var_456:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_123];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_123:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_639.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
      ...
      {
         return [RoomWidgetChatMessage.const_556,RoomWidgetChatSelectAvatarMessage.const_510];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_556:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_123,_container.roomSession,0,"Version 24869-24868-201002110139");
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_95:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_79:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_510:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_774 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_774);
            }
            if(var_456 == null)
            {
               var_457.x = 0;
               var_457.y = 0;
               var_457.z = 0;
               var_456 = _loc4_.getScreenPoint(var_457);
               var_774 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_457.x = 0;
            var_457.y = 0;
            var_457.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_457);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_456.x || _loc8_.y != var_456.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_456,_loc5_));
