package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_547);
               _loc6_.id = param1.id;
            ...
            case RoomObjectCategoryEnum.const_19:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_276)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_896)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_664);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_208)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_530);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1335;
                  if(!_loc25_)
                  {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_538.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_33);
            var_538.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_530);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_279);
         ...
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_508);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_491);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1121);
         _loc1_.push(RoomWidgetPetCommandMessage.const_708);
         _loc1_.push(RoomWidgetPetCommandMessage.const_605);
      ...
      public function dispose() : void
      {
         ...
         if(var_538 != null)
         {
            _loc1_ = var_538.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_538.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_279:
            ...
            case RoomWidgetUserActionMessage.const_502:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_927,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_390:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_508:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_491:
            ...
            case RoomWidgetUserActionMessage.const_637:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_605:
