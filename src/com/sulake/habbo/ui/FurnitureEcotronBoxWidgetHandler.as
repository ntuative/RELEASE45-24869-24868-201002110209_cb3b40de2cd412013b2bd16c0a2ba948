package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_615,RoomWidgetEcotronBoxOpenMessage.const_594,RoomWidgetEcotronBoxOpenedMessage.const_1304];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_615:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_594:
