package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_381:
               ...
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_667);
            ...
            case RoomEngineObjectEvent.const_72:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_945));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_649,RoomWidgetDimmerSavePresetMessage.const_623,RoomWidgetDimmerChangeStateMessage.const_613,RoomWidgetDimmerPreviewMessage.const_632];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDimmerSavePresetMessage.const_623:
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_613:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_632:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomEngineObjectEvent.const_72);
         return _loc1_;
      }
