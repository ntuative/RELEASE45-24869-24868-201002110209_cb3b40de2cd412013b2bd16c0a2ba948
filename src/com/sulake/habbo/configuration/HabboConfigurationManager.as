package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1389:String = "%";
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         (_context as CoreComponent).error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,CoreComponent.const_1159);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_980[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_856 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_150));
         if(var_1883)
         {
      ...
      {
         var _loc4_:String = var_980[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1882);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1389);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1389,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
