package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1374,this._model.mode != ThumbnailEditorModel.const_36);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1374 = IButtonWindow(find("top_tab"));
         var_1375 = IButtonWindow(find("obj_tab"));
         var_1658 = IWindowContainer(find("tile_grid"));
         var_1657 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1374,onTopTabButton);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1658;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1657;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_38,HabboWindowStyle.const_20,HabboWindowParam.const_49,new Rectangle(0,0,param1.width,66)));
