package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2198:ISessionDataManager;
      
      private var var_2199:RoomCreateViewCtrl;
      ...
      private var var_1298:RoomInfoViewCtrl;
      
      private var var_75:IHabboCatalog;
      
      private var var_381:Tabs;
      
      private var var_497:MainViewCtrl;
      
      private var var_2197:Array;
      
      private var var_941:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_497 = new MainViewCtrl(this);
         var_1298 = new RoomInfoViewCtrl(this);
         var_2199 = new RoomCreateViewCtrl(this);
         var_2008 = new RoomThumbnailRenderer(this);
         var_941 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_497.startSearch(Tabs.const_193,Tabs.const_264,param1);
         var_497.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_173 != null)
         {
            var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_173 != null)
         {
            var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_98,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_98,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2198 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_497.startSearch(Tabs.const_239,Tabs.const_207);
         var_381.getTab(Tabs.const_239).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_497.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
