package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2121:IButtonWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1523 = IWindowContainer(find("event_type_disabled_cont"));
            var_2120 = ITextWindow(find("event_type_disabled_text"));
            var_1522 = ITextWindow(find("create_caption"));
            var_1524 = ITextWindow(find("edit_caption"));
            var_1280 = IButtonWindow(find("create_button"));
            var_1279 = IButtonWindow(find("edit_button"));
            var_2121 = IButtonWindow(find("cancel_button"));
            var_1281 = IButtonWindow(find("end_button"));
            var_843 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1280,onCreateButtonClick);
            Util.setProcDirectly(var_1279,onEditButtonClick);
            Util.setProcDirectly(var_1281,onEndButtonClick);
            Util.setProcDirectly(var_2121,onCancelButtonClick);
            ...
            var_842 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
