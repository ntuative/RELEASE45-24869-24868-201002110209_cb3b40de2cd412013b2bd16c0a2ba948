package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private function populateForm() : void
      {
         ...
         changePasswordField(_loc1_.doorMode == RoomSettingsData.const_105);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         setCategorySelection(_loc1_.categoryId);
         refreshMaxVisitors(_loc1_);
         setTag(var_842,_loc1_.tags[0]);
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_146,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_240.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_240.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_240.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_240.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_240.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_240.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_240.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_240);
         var_240.findChildByName("ruler").visible = true;
         ...
         if(var_83.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_240,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_38,HabboWindowStyle.const_20,HabboWindowParam.const_49,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1391.visible = _inRoom;
         var_1390.visible = _inRoom;
         var_1716.visible = var_437;
         var_1717.visible = !var_437;
         if(var_437)
         {
            var_942.visible = true;
            var_1130.visible = false;
            refreshFlatControllers();
            var_942.height = Util.getLowestPoint(this.var_942) + 4;
         }
         else
         {
            populateForm();
         ...
         var_1393.text = !!var_437 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1391.name,var_1127.name,var_944.name,var_942.name,var_1130.name,var_1390.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowWalkThrough = var_1128.isSelected;
         _loc2_.tags = new Array();
         addTag(var_842,_loc2_.tags);
         addTag(var_841,_loc2_.tags);
         this.clearErrors();
         this.var_943 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_366 || var_943 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_943 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1132)
         {
         ...
         {
            setTagError(this.var_842,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            setTagError(this.var_842,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_941.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_505,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_950,onDoorModePasswordUnselect);
         ...
         this.var_842 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_841 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_941 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         ...
         this.var_1128 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1391 = IWindowContainer(_window.findChildByName("header_container"));
         var_1127 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_944 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_942 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1390 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1130 = IWindowContainer(_window.findChildByName("footer_container"));
         var_240 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_940 = IWindowContainer(_window.findChildByName("password_container"));
         var_1717 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1716 = ITextWindow(_window.findChildByName("advanced_caption"));
