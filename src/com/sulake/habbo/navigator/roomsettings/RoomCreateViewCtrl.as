package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_806:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1222 = new Timer(100);
         var_1222.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_55 = new Array();
         var_55.push(new RoomLayout(false,104,"a"));
         var_55.push(new RoomLayout(false,94,"b"));
         var_55.push(new RoomLayout(false,36,"c"));
         var_55.push(new RoomLayout(false,84,"d"));
         var_55.push(new RoomLayout(false,80,"e"));
         var_55.push(new RoomLayout(false,80,"f"));
         var_55.push(new RoomLayout(true,80,"g"));
         var_55.push(new RoomLayout(true,74,"h"));
         var_55.push(new RoomLayout(false,416,"i"));
         var_55.push(new RoomLayout(false,320,"j"));
         var_55.push(new RoomLayout(false,448,"k"));
         var_55.push(new RoomLayout(false,352,"l"));
         var_55.push(new RoomLayout(false,384,"m"));
         var_55.push(new RoomLayout(false,372,"n"));
         var_55.push(new RoomLayout(true,416,"o"));
         var_55.push(new RoomLayout(true,352,"p"));
         var_55.push(new RoomLayout(true,304,"q"));
         var_55.push(new RoomLayout(true,336,"r"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_994 = new TextFieldManager(_navigator,ITextFieldWindow(var_17.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_55.length)
         {
            _loc6_ = var_55[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_55[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_38,HabboWindowStyle.const_20,HabboWindowParam.const_49,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_806.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1221 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1221 = true;
            _loc3_.y = 1;
