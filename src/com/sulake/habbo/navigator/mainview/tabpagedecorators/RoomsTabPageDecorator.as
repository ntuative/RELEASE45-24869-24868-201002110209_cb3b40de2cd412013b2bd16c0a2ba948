package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_313);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_655);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_313,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_440 == null)
         {
            var_440 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_440.procedure = onChangeFilter;
