package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboFriendList, param2:int, param3:int, param4:String)
      {
         ...
         var_680.addEventListener(TimerEvent.TIMER,onHideTimer);
      }
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(var_43 == null)
         {
            var_43 = IWindowContainer(_friendList.getXmlWindow(var_1170));
         ...
         var_43.x = _loc4_.x - _loc3_.x + var_1827 + param2.width;
         ...
         {
            var_43.x = 0 + _loc4_.x - _loc3_.x + var_1828;
