package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_535:String = "bg";
       
      
      private var var_1782:IContainerButtonWindow;
      
      private var var_1781:IContainerButtonWindow;
      ...
      {
         var_1781 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1783 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1782 = initButton("room_invite",onInviteButtonClick,param1);
         var_1784 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_535);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_62,param4);
         _loc6_.visible = true;
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1781,isEnableMinimailButton(_loc1_));
         setEnabled(var_1783,isEnableHomeButton(_loc1_));
         setEnabled(var_1782,isEnableInviteButton(_loc1_));
         setEnabled(var_1784,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_535);
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_62,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_62).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_62,param1);
      }
