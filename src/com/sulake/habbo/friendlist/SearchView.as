package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_602:ITextFieldWindow;
      ...
      {
         var_602 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_602.procedure = onSearchInput;
         var_602.addEventListener(WindowKeyboardEvent.const_117,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_42.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_299,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_602.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
