package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1402:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_305 && _loc4_.state != FriendRequest.const_302)
            {
      ...
      {
         var_1433 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1432 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1432.procedure = onDismissAllButtonClick;
         var_1433.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_80,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_909)
         {
