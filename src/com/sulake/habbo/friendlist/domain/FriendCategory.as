package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_848:int = 0;
      ...
      {
         return Math.ceil(this.var_227.length / const_286);
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_858 + 1) * const_286,this.var_227.length);
      }
