package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1700:IAvatarRenderManager;
      
      private var var_1386:AvatarSearchResults;
      
      private var var_122:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_748:FriendRequests;
      ...
      private var var_1701:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_381:FriendListTabs;
      
      private var var_1702:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1387:OpenedToWebPopup;
      ...
      {
         var_1701 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_316 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1386 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1387 == null)
         {
            var_1387 = new OpenedToWebPopup(this);
         }
         var_1387.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_748.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_748.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_381.findTab(FriendListTab.const_80).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_748.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_173.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_122 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_748 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_316.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_316.addCategory(new FriendCategory(FriendCategory.const_848,getText("friendlist.friends")));
         var_316.addCategory(new FriendCategory(FriendCategory.const_440,getText("friendlist.friends.offlinecaption")));
         ...
         getBuddyRequests();
         registerListeners();
         var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_98,HabboToolbarIconEnum.FRIENDLIST));
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_62);
      ...
      {
         var _loc2_:IAvatarImage = var_1700.createAvatarImage(param1,AvatarScaleType.const_81);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1700 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_748.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_381.findTab(FriendListTab.const_80);
      ...
      {
         var_1702 = param2 as IHabboNotifications;
      ...
      {
         var_173 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1386.searchReceived(_loc2_.friends,_loc2_.others);
