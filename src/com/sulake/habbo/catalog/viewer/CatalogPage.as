package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1319:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_761:ICatalogViewer;
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1118) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         if(_loc1_ != null)
         {
            var_52.push(new ClubGiftWidget(_loc1_,var_75.getClubGiftController()));
         }
         for each(_loc2_ in var_52)
         {
            _loc2_.page = this;
            _loc2_.events = var_1319;
            _loc2_.init();
         }
         var_1319.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1319.dispatchEvent(param1);
      }
