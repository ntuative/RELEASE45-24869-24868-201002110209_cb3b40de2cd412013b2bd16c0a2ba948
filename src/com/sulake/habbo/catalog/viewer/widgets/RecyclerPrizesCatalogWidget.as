package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_761:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_628.length)
         {
            createLevelItem(var_628[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_761 = new PrizeViewer();
         var_522 = new Map();
         var_628 = recycler.getPrizeTable();
         if(var_628 == null)
         {
            return;
         }
         name_1 = _window.findChildByName("itemList") as IItemListWindow;
         ...
         var_1767 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_628[0].prizes.length > 0)
         {
            select(var_628[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1767) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1337) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_761.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
