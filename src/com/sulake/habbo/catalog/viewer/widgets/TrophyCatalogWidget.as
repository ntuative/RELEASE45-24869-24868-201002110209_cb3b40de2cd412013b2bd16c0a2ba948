package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_364.getWithIndex(var_176);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_435);
            if(_loc3_ == null)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_79.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
         var_79.invalidate();
      }
      ...
      override public function init() : void
      {
         ...
         _loc4_ = var_364.getWithIndex(var_176);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_435);
            if(_loc3_ == null)
            {
