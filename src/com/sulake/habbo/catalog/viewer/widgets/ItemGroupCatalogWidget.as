package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_513[var_909] as Array;
      ...
      {
         var _loc2_:Offer = var_513[var_909][var_1623];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_457 || _loc1_.pricingModel == Offer.const_344)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_57 || _loc3_.productType == ProductTypeEnum.const_58)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_910.indexOf(_loc5_) == -1)
                        {
                           var_910.push(_loc5_);
                           var_513.push(new Array());
                        }
                        _loc6_ = var_910.indexOf(_loc5_);
                        (var_513[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_909 = var_894.getGridItemIndex(param1.view);
