package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1100 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_286 = null;
         for each(_loc1_ in var_1102)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1100) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_610.width,var_610.height,true,0);
               _loc3_.bitmap.copyPixels(var_610,var_610.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1101.width,var_1101.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_919.width,var_919.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_919,var_919.rect,new Point(0,0),null,null,true);
