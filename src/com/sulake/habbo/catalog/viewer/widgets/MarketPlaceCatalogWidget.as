package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1109:MarketPlaceOfferData;
      
      private const const_1386:int = 1;
      
      private const const_1591:int = 40;
      
      private var var_423:IWindowContainer;
      
      private const const_1385:int = 2;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         if(!var_423)
         {
            ...
            var_423 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_423)
         {
            return;
         ...
         updateStatusDisplay(const_1385,_loc2_.length);
         if(!var_357)
         {
            var_357 = new Timer(25);
            var_357.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_734 = 0;
         populateList();
         var_357.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !name_1 || !var_522)
         {
            return;
         }
         var _loc3_:* = [];
         if(name_1.groupListItemsWithID(param1,_loc3_))
         {
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !name_1 || !var_423 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_423.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_356.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_357)
         {
            var_357.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_357 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_734 >= var_522.length)
            {
               return true;
            }
            addListItem(var_522.getWithIndex(var_734));
            ++var_734;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1109.offerId);
                  hideDetails();
            }
            return;
         }
      ...
      private function onOfferListEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc3_ = name_1.getListItemIndex(param1.window.parent);
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_356));
            _loc7_.selection = 0;
         }
      }
      ...
      public function displayMainView() : void
      {
         ...
         name_1 = window.findChildByName("offer_list") as IItemListWindow;
