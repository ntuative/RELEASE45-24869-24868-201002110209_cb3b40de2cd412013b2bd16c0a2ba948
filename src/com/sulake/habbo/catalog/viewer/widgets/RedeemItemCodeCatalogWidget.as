package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_979 != null)
         {
            var_979.removeEventListener(WindowKeyboardEvent.const_117,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_979 != null)
         {
            var_979.addEventListener(WindowKeyboardEvent.const_117,windowKeyEventProcessor);
         }
      }
