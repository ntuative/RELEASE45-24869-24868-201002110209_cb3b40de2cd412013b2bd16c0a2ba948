package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc1_)
         {
            ...
            if(_loc4_)
            {
               ...
               var_522.add(_loc5_.offerId,_loc5_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_187)
         {
            var_187 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_187)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_187.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_187.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
      ...
      override public function init() : void
      {
         ...
         if(!_loc1_)
         {
            ...
            name_1 = _loc1_.findChildByName("gift_list") as IItemListWindow;
         }
         update();
      }
      ...
      {
         if(!param1 || !param2 || !var_522 || !_controller)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_522.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
