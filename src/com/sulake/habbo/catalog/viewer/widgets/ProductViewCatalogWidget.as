package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1260:IScrollbarWindow;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_382:
                  _loc4_ = var_1259.clone();
                  if(var_574 != null)
                  {
                     var_574.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_574,var_1260,var_1337);
                  }
                  break;
               case Offer.const_457:
               case Offer.const_344:
                     ...
                     case ProductTypeEnum.const_177:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_275,AvatarAction.const_616);
                              _loc13_.appendAction(AvatarAction.const_700,_loc6_.productClassId);
      ...
      {
         var_1163 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1164 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_79 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1506 = new Point(var_79.x,var_79.y);
         var_574 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1260 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_574 == null)
         {
         ...
         var_1259 = _loc2_.content as BitmapData;
