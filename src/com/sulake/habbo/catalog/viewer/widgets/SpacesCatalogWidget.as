package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1148:String = "default";
      
      private var var_1175:Array;
      
      private var var_974:BitmapData = null;
      
      private var var_210:int = 0;
      
      private var var_643:int = 0;
      
      private var var_1147:String = "1.1";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_974 != null && var_973 != null)
         {
            setRoomImage(var_974,var_973);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_163.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_210 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_210];
                  if(_loc9_ != null)
                  {
                     var_1148 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_163.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_242];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_163.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_243];
               if(_loc13_ != null)
               {
                  var_1147 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_167:
               ...
               for each(_loc8_ in var_163.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_644 = _loc8_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1148);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1177[var_280];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1147);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1148,var_1147,64,this,"window_romantic_wide");
