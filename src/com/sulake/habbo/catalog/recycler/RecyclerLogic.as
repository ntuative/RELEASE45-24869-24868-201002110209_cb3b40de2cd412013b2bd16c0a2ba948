package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_720:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1360)
         {
            case RecyclerStatusMessageEvent.const_1124:
               ...
               var_75.setupInventoryForRecycler(true);
               verifyRoomSessionStatus();
               updateRecyclerSlots();
               updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_814:
               if(_view == null)
               {
                  return;
               }
               _view.method_10();
               var_75.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1217:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         var_233 = const_719;
         var_90 = new Array(const_152);
         if(param1 == null)
         {
            return;
         }
         _view = param1;
         var_75.getRecyclerStatus();
      }
      ...
      public function storePrizeTable(param1:Array) : void
      {
         ...
         {
            _loc3_ = new PrizeLevelContainer(param1[_loc2_],var_75);
            var_628.push(_loc3_);
            _loc2_++;
         }
      }
      ...
      {
         return active && var_233 == const_321;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         var itemId:int = var_75.requestInventoryFurniToRecycler();
         if(itemId == 0)
         {
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_75.returnInventoryFurniFromRecycler(var_90[param1].id))
         {
            return;
         }
         var_90[param1] = null;
