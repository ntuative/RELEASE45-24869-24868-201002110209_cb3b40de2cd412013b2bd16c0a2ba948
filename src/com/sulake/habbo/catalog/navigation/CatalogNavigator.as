package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2319:String = "magic.pixels";
      
      private var var_2318:String = "catalog.page.club";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_75.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_75.configuration.getKey("link.format.credits","/credits");
            var_75.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_75.openCatalogPage(var_2318,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_75.loadCatalogPage(param1.pageId);
         var_75.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_75.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_75.loadCatalogPage(_loc2_.pageId);
         }
