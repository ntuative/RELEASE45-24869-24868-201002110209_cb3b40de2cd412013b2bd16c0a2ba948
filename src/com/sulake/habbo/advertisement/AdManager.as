package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1793:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_391,0,0,_loc4_,var_1407,var_1795,var_1793));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1792 = int(_config.getKey("interstitial.interval","30000"));
         var_1794 = int(_config.getKey("interstitial.show.time","5000"));
         var_1408 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1151 = _loc2_.imageUrl;
         var_1407 = _loc2_.clickUrl;
         if(var_1151 != "" && var_1407 != "")
         {
            _loc3_ = var_1151;
            ...
            _loc4_ = new URLRequest(var_1151);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1152 != "")
         {
            ...
            if(var_206 == null)
            {
               var_206 = new Timer(var_1794,1);
               var_206.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_206.reset();
            ...
            var_206.start();
            _loc4_ = new URLRequest(var_1152);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      {
         if(var_206 != null && true)
         {
            return;
         }
         if(isValidAdImage(param1))
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_375,0,0,param1.bitmapData,var_1796));
            var_630 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1793 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      
      public function showInterstitial() : Boolean
      {
         if(var_206 != null && false)
         {
            var_206.reset();
            return false;
         }
         ...
         if(var_1408 > 0 && var_1406 >= var_1408)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_630;
         if(_loc1_ > var_1792)
         {
            ++var_1406;
      ...
      {
         var_560 = param2 as IHabboCommunicationManager;
         if(var_560 == null)
         {
            return;
         }
         _connection = var_560.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
