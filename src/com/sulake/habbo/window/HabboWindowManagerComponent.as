package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_320:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1005:uint = 1;
      ...
      private var var_1080:ProfilerAgentTask;
      
      private var var_1082:IEventDispatcher;
      
      private var var_2331:uint = 0;
      
      private var var_1081:ProfilerAgentTask;
      
      private var var_1083:ProfilerOutput;
      
      private var var_604:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1082 = Component(param1).events;
            var_721 = new Array();
      ...
      {
         return var_272[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_272[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_604 = new WindowRenderer(_loc4_);
         var_272 = new Array(const_320);
         var _loc6_:int = 0;
         while(_loc6_ < const_320)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_604,this,_localization,var_185,new Rectangle(0,0,var_185.stageWidth,var_185.stageHeight),this);
            var_272[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_408 = var_272[const_1005];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_408.getMouseCursor().defineCustomCursorType(MouseCursorType.const_312,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_408.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1354,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_272[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_272.pop()).dispose();
            }
            if(_localization)
            {
      ...
      {
         return var_272[param1].getDesktopWindow().getChildAt(var_408.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1083 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1083 = new ProfilerOutput(_loc3_,this,var_604);
               var_1080 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1080);
               var_1081 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1081);
               var_899 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1082.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_320 - 1;
            while(_loc2_ >= 0)
            {
               var_272[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_899)
         ...
         var_1082.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_320)
         {
            var_272[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_899)
         {
         ...
         var_1082.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_721[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_721[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1145,param2.name + ": " + param2.toString());
            }
         }
      }
   }
