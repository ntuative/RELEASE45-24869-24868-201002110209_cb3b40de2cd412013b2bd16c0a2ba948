package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_362:PartSetsData;
      
      private var var_1694:PartOffsetData;
      
      private var var_746:AvatarActionManager;
      
      private var var_137:IAssetLibrary;
      
      private var var_2260:IAssetLibrary;
      
      private var var_1334:Boolean = false;
      
      private var var_1693:AvatarRenderManager;
      ...
      private var var_1385:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_362 = new PartSetsData();
         _animationData = new AnimationData();
         var_1385 = new AvatarStructureDownloadSet();
         var_620 = new AnimationManager();
         var_621 = param4;
         var_1694 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_746.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_746.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_746.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_362.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_362.method_13(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_746.getDefaultActionType();
         var _loc7_:Array = var_362.method_13(param3.definition);
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_362.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_362.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_621 + " ready to go!");
         if(var_621 == AvatarType.const_75)
         {
            var_362.getPartDefinition("ri").appendToFigure = true;
            var_362.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_75:
               var_1385.add(new AvatarStructureDownload(var_137,_loc5_,var_433));
               break;
            case AvatarType.PET:
         }
         var_1385.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_746 = new AvatarActionManager(var_137,var_621);
      }
      ...
      {
         return var_1694.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      {
         return var_746.sortActions(param1);
      }
   }
}
