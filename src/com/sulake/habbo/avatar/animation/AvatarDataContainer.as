package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1536 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_2166 = parseInt(_loc2_,16);
         var_2167 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1400 = _rgb >> 16 & 255;
         var_1401 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1417 = var_1400 / 255 * 1;
         var_1416 = var_1401 / 255 * 1;
         var_1418 = _b / 255 * 1;
         if(var_1536 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1417,var_1416,var_1418,_alphaMultiplier);
         var_1035 = generatePaletteMapForGrayscale(var_2167,var_2166);
      }
      
      public function get reds() : Array
      {
         return var_1035.getValue("reds") as Array;
      }
      ...
      {
         return var_1035.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1035.getValue("greens") as Array;
      }
      ...
      {
         return var_1035.getValue("alphas") as Array;
      }
