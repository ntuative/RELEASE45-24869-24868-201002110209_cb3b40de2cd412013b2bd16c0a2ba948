package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_337:Object;
      
      private var var_777:IItemGridWindow;
      
      private var var_1436:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_777 = _view.findChildByName("thumbs") as IItemGridWindow;
            var_1436 = _view.findChildByName("colors") as IItemGridWindow;
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_1436.getGridItemIndex(param1.window);
      ...
      {
         var _loc3_:IWindow = var_777.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_34)
         {
            _loc3_ = var_777.getGridItemIndex(param1.window);
