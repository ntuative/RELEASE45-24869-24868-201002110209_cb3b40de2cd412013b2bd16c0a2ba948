package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private static var var_70:Array = [];
      ...
      private const const_1593:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1420:BitmapData;
      
      private const const_1592:int = 13421772;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_345 = new BitmapData(1,1,true,16777215);
         }
         var_1525 = param5;
      ...
      {
         var _loc3_:Number = var_70.indexOf(param1.type);
         var _loc4_:Number = var_70.indexOf(param2.type);
         if(_loc3_ < _loc4_)
         {
            return -1;
         }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_345 != null)
            {
               _loc2_ = var_345.clone();
               if(_color != null && var_1525)
               {
         ...
         if(var_578 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1420,var_1420.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1592;
         }
         else
         {
            _window.color = const_1593;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_976 + "_" + FigureData.const_214;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_1525 && _loc2_.subColorIndex)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_976 + "_" + FigureData.const_214;
