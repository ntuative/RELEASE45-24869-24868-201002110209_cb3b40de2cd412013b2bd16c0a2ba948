package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1592:int = 8947848;
      
      private const const_1593:int = 13421772;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_610.width,var_610.height,true,0);
            _loc1_.bitmap.copyPixels(var_610,var_610.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1101.width,var_1101.height,true,0);
            _loc4_ = var_1101.clone();
            _loc4_.colorTransform(_loc4_.rect,var_765.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_919.width,var_919.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_919,var_919.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1420,var_1420.rect,new Point(0,0),null,null,true);
            }
         }
      }
