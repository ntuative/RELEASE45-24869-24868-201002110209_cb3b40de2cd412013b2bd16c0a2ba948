package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_657["null"] = new AvatarEditorGridView(param1,FigureData.const_37,param2,param3);
         attachImages();
      ...
      {
         var _loc4_:AvatarEditorGridView = var_657[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:AvatarEditorGridView = var_657[var_1457];
         if(_loc4_ == null)
         {
            return;
         }
