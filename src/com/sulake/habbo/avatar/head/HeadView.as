package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_657["null"] = new AvatarEditorGridView(param1,FigureData.const_101,param2,param3);
         var_657["null"] = new AvatarEditorGridView(param1,FigureData.const_126,param2,param3);
         var_657["null"] = new AvatarEditorGridView(param1,FigureData.const_122,param2,param3);
         var_657["null"] = new AvatarEditorGridView(param1,FigureData.const_130,param2,param3);
         var_657["null"] = new AvatarEditorGridView(param1,FigureData.const_129,param2,param3);
         attachImages();
         switchCategory(FigureData.const_101);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_657[var_1457];
         if(_loc2_ == null)
         {
            return;
         }
