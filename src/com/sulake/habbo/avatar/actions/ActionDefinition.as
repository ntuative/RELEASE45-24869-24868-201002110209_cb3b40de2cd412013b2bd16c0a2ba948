package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1763 = parseInt(param1.@precedence);
         var_1766 = String(param1.@activepartset);
         var_1764 = String(param1.@assetpartdefinition);
         var_1759 = String(param1.@lay);
         var_1234 = String(param1.@geometrytype);
         var_1760 = Boolean(parseInt(param1.@main));
         var_1761 = Boolean(parseInt(param1.@var_2115));
         var_1762 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1145 = _loc2_.split(",");
         }
      ...
      {
         return var_1145.concat(getTypePrevents(param1));
      }
