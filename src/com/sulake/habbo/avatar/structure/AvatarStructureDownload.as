package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_873:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_2018:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1489 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2018.append(var_1489);
         dispatchEvent(new Event(AvatarStructureDownload.const_873));
      }
   }
}
