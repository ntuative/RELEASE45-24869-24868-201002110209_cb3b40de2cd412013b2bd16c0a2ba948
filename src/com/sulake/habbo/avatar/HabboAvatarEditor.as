package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1040:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1040.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1041)
         {
            ...
            var_702["null"] = new FigureData(this);
            var_702["null"] = new FigureData(this);
            _loc1_ = var_702["null"];
            _loc2_ = var_702["null"];
            ...
            var_316 = new Map();
            var_316.add(AvatarEditorCategory.const_966,new GenericModel(this));
            var_316.add(AvatarEditorCategory.const_30,new HeadModel(this));
            var_316.add(AvatarEditorCategory.const_273,new TorsoModel(this));
            var_316.add(AvatarEditorCategory.const_1351,new LegsModel(this));
            var_316.add(AvatarEditorCategory.const_564,new WardrobeModel(this));
            var_1041 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_316.getValue(AvatarEditorCategory.const_564);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_316.getValue(AvatarEditorCategory.const_564);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1040.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1311)
               {
                  _loc19_ = true;
               }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_408 == null)
            {
               var_408 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_38,HabboWindowStyle.const_20,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_966);
         if(var_163 != null)
         {
            urlString = var_163.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_676,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1040 = var_1084.getFigureData(AvatarType.const_75);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1042 = param3;
         var _loc4_:FigureData = var_702[param2];
         if(_loc4_ == null)
         {
            return;
         }
