package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_77 * param1.y;
         _loc2_.y = var_77 * param1.x - var_76 * param1.z;
         _loc2_.z = var_76 * param1.y - _y * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_76 * var_76 + _y * _y + var_77 * var_77);
      }
      ...
      {
         return var_76 * param1.x + _y * param1.y + var_77 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_76 + "," + _y + "," + var_77 + "," + var_923 + ")";
      }
