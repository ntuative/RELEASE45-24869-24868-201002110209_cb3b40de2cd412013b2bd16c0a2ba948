package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1474:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         var_473 = new Matrix4x4();
         var_662 = new Dictionary();
         var_1474 = new AvatarSet(param1.avatarset[0]);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_473 = var_473.identity().rotateY(param3);
            return _loc5_.getParts(var_473,var_815,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1474.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_473 = var_473.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_473);
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1474.findAvatarSet(param1);
         if(_loc3_ != null)
         {
