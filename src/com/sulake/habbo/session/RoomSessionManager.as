package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         {
            gotoRoom(var_1842,var_1840,var_1167);
            var_1168 = false;
            var_1167 = "";
         }
      }
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null && var_74 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < var_74.length)
            {
               _loc3_ = var_74[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
      ...
      public function startSession(param1:IRoomSession) : Boolean
      {
         ...
         {
            var_773 = false;
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_73,param1));
      ...
      private function createHandlers() : void
      {
         ...
         var_74.push(new RoomSessionHandler(_connection,this));
         var_74.push(new RoomChatHandler(_connection,this));
         var_74.push(new RoomUsersHandler(_connection,this));
         var_74.push(new RoomPermissionsHandler(_connection,this));
         var_74.push(new AvatarEffectsHandler(_connection,this));
         var_74.push(new RoomDataHandler(_connection,this));
         var_74.push(new PresentHandler(_connection,this));
         var_74.push(new PlaceObjectErrorHandler(_connection,this));
         var_74.push(new TeleportErrorHandler(_connection,this));
         var_74.push(new GenericErrorHandler(_connection,this));
         var_74.push(new PollHandler(_connection,this));
         var_74.push(new VoteHandler(_connection,this));
         var_74.push(new LidoHandler(_connection,this));
         var_74.push(new RoomDimmerPresetsHandler(_connection,this));
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_74.length)
            {
               _loc4_ = var_74[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_82,_loc4_));
            _loc4_.dispose();
         }
      }
