package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1444,var_1443);
         }
      }
      ...
      {
         if(param1 != var_1689 || param2 != var_1684)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1687);
      }
      ...
      {
         if(_controller != null && false && var_212 != null)
         {
            _controller.furniModel.removeLockFrom(var_212.id);
            var_212 = null;
         }
      }
