package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_985:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_556 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_556.width;
         var_85 = var_556.height;
         var_984 = param5;
         var_796 = param6;
         var_213 = Math.floor(var_984 / _thumbWidth);
         var_15 = new BitmapData(var_984,var_796);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_15.height < var_796)
         {
            _loc12_ = new BitmapData(var_15.width,var_796);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_556.width,var_556.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_556.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_556,var_556.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_985 != null)
         {
            _loc1_ = var_985.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_465 = resolveRowCountFromList();
         if(var_465 == 0)
         {
            var_15 = new BitmapData(var_984,var_796);
            return;
         }
         var_15 = new BitmapData(Math.max(var_213 * _thumbWidth,var_984),Math.max(var_465 * var_85,var_796),true,16777215);
         var_15.fillRect(var_15.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_465)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_213 && var_15.height < _loc3_.y * var_85)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_213 - 1),var_85);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_213 - 1),0,_thumbWidth,var_15.height);
         _loc2_.copyPixels(var_15,_loc4_,new Point(0,var_85),null,null,true);
         _loc4_ = new Rectangle(0,var_85,_thumbWidth * (var_213 - 1),0 - var_85);
