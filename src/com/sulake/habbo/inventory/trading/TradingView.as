package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_744:uint = 4284532064;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_967)
            {
            ...
            var_325.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_414);
            var_325.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_160)
            {
               var_160.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_160.stop();
               var_160 = null;
            }
            if(var_325 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1462 == null)
         {
            var_1462 = createMinimizedWindow();
         }
         if(!var_1972)
         {
            return var_54;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_160 == null)
         {
            var_160 = new Timer(1000,3);
            var_160.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_160.reset();
         var_160.repeatCount = 3;
         var_160.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_54)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_744) : uint(const_745);
            }
