package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_53,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_684);
         _loc2_.refreshViews();
         var_8.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.itemType == "S")
            {
               ...
               _loc6_.push(new FloorItem(_loc9_.method_2,_loc9_.itemTypeID,_loc9_.roomItemID,_loc9_.category,true,true,true,true,_loc9_.stuffData,_loc9_.extra,_loc9_.timeToExpiration,_loc9_.creationDay,_loc9_.creationMonth,_loc9_.creationYear,null,_loc9_.songID));
            }
            else
            {
               ...
               _loc6_.push(new WallItem(_loc9_.method_2,_loc9_.itemTypeID,_loc9_.roomItemID,_loc9_.category,true,true,true,true,_loc9_.stuffData,_loc9_.extra));
            }
            _loc10_++;
         }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_143);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_8.setInventoryCategoryInit(InventoryCategory.const_314);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_53);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_8.setInventoryCategoryInit(InventoryCategory.const_228);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_413);
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
