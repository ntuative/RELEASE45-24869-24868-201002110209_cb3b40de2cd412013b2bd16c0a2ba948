package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_179,onObjectPlaced);
         var_484 = new Timer(const_1082,1);
         var_484.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_237;
      }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_179,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_484 != null)
            {
               var_484.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_484.stop();
               var_484 = null;
            }
            if(var_130 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_266)
         {
         ...
         else if(param3 == FurniCategory.const_263)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_237:
               ...
               break;
            case InventorySubCategory.const_768:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_413);
      ...
      {
         if(param1 == InventoryCategory.const_53 && false)
         {
      ...
      {
         if(var_831 && param1.type == RoomEngineObjectEvent.const_179)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_266 || _loc3_.category == FurniCategory.const_296 || _loc3_.category == FurniCategory.const_263)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_400 = new Map();
         var_400.add(const_24,new Array());
         var_400.add(const_25,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
