package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1621:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_468 = new Map();
         var_468.add(FurniModel.const_24,new FurniGridView(_model,FurniModel.const_24,_windowManager,_assetLibrary,_roomEngine));
         var_468.add(FurniModel.const_25,new FurniGridView(_model,FurniModel.const_25,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_468.getValue(var_467);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_467);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_266)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_263)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_692 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
