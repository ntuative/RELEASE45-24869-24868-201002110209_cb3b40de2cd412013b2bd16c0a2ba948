package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1110);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_614 == InventoryCategory.const_143)
            {
               toggleCategoryView(InventoryCategory.const_143);
            }
            else if(var_614 == InventoryCategory.const_53)
            {
               toggleCategoryView(InventoryCategory.const_53);
            }
            else if(_controller != null)
            {
               _controller.toggleInventoryPage(InventoryCategory.const_53);
            }
         }
      }
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_173 != null && var_735)
            {
               var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_173 != null)
         {
            var_173.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_98,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_173 != null)
         {
            var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_533,HabboToolbarIconEnum.INVENTORY,var_11 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_173 != null && var_735)
         {
            var_173.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_735 = false;
         }
         _controller.inventoryViewOpened(var_613);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_614 || !_controller.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_173 != null && var_735)
