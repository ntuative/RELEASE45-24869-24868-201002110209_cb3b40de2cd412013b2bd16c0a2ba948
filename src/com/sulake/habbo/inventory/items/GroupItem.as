package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2241:BitmapData;
      
      protected var var_885:Boolean;
      ...
      protected var var_345:BitmapData;
      
      private const const_1389:Number = 0.2;
      
      protected var var_1326:Boolean;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1389;
               _loc1_.blend = const_1389;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1326 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2241;
               _loc5_.visible = true;
            }
            else
            {
