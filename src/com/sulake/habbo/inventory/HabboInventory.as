package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_73,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_82,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_38.getValue(InventoryCategory.const_684));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_38.getValue(InventoryCategory.const_53));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_774));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_38.getValue(InventoryCategory.const_143));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1596);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_38.getValue(InventoryCategory.const_314));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_742.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_742.splice(_loc3_,1);
            }
         }
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_237:
               _view.toggleCategoryView(InventoryCategory.const_53,false);
         }
      }
      ...
      {
         return TradingModel(var_38.getValue(InventorySubCategory.const_237));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_565 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_742.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_38.getValue(InventoryCategory.const_413) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1380 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_38.getValue(InventoryCategory.const_228));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_73,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_82,roomSessionEventHandler);
         ...
         var_38.add(InventoryCategory.const_413,_loc3_);
         ...
         var_38.add(InventoryCategory.const_53,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_565);
         var_38.add(InventoryCategory.const_228,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_38.add(InventoryCategory.const_684,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_565);
         var_38.add(InventoryCategory.const_314,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_38.add(InventorySubCategory.const_237,_loc8_);
         ...
         var_38.add(InventoryCategory.const_143,_loc10_);
