package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_404:Sprite = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_69,onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_69,onShowLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_404 = new Sprite();
            var_404.addChild(new Bitmap(_image));
            var_404.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_404.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_404);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1530 != "")
         {
            HabboWebTools.openWebPage(var_1530);
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_69,onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_69,onShowLoadingBar);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_69)
         {
            return;
         }
         if(!createWindow())
      ...
      override public function dispose() : void
      {
         if(var_404 != null)
         {
            var_404.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_404 = null;
         }
         if(_image != null)
         {
