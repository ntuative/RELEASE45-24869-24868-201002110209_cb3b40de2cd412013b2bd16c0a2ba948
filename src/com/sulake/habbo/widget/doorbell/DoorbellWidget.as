package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1012:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_487,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_102,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_487,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_102,onDoorbellHandled);
