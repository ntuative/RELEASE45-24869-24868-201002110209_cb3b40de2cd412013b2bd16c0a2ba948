package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_46 = (var_334.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_46 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_42 = var_46.findChildByName("user_list") as IItemListWindow;
         var_46.visible = false;
      ...
      private function createListItem(param1:String, param2:int) : IWindow
      {
         ...
         var _loc4_:IWindowContainer = var_334.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function update() : void
      {
         ...
         if(var_42 != null)
         {
            ...
            {
               var_42.addListItem(createListItem(var_334.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
