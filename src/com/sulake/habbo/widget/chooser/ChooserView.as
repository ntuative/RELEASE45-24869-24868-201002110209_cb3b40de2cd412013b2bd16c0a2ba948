package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1604:uint = 4.282169599E9;
      ...
      private function createWindow() : void
      {
         ...
         name_1 = _window.findChildByName("item_list") as IItemListWindow;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1445);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(name_1 == null || param1 < 0 || param1 > name_1.numListItems || param1 == var_649)
         {
            return;
         }
         if(var_649 != -1)
         {
            _loc2_ = name_1.getListItemAt(var_649) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_649 % 2) ? uint(const_1404) : uint(const_1403);
            }
         }
         _loc2_ = name_1.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1604;
            var_649 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         if(_window == null || name_1 == null || param1 == null)
         {
            return;
         }
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               name_1.addListItem(_loc5_);
            }
            _loc6_++;
         }
         _loc6_ = 0;
         while(_loc6_ < name_1.numListItems)
         {
            _loc5_ = name_1.getListItemAt(_loc6_) as IWindowContainer;
            if(_loc5_ != null)
            {
               _loc5_.width = name_1.width;
            }
            _loc6_++;
         }
         var_649 = -1;
