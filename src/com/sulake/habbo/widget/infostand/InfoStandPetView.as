package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1605:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1610:String = "level";
      
      private var var_93:IItemListWindow;
      
      private const const_1612:String = "energy";
      ...
      private var var_249:PetCommandTool;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_200 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_200 != null)
         {
            var_93 = var_200.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_200.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_200.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_93 == null || var_200 == null || var_53 == null)
         {
            return;
         }
         ...
         var_200.height = NaN;
         _window.width = Math.max(var_200.width,var_53.width);
      ...
      private function openTrainView() : void
      {
         if(var_249 == null)
         {
            var_249 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1122.getValue(var_668) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_249.showWindow(true);
            var_249.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1610,param1.level,param1.levelMax);
         updateStateElement(const_1608,param1.experience,param1.experienceMax);
         updateStateElement(const_1612,param1.energy,param1.energyMax);
         updateStateElement(const_1607,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_668 = param1.id;
         var_1122.remove(param1.id);
         var_1122.add(param1.id,param1);
         if(var_249 && var_249.isVisible() && param1.isOwnPet)
         {
            var_249.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_249.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1606,const_1611,false);
         ...
         _loc5_.fillRect(_loc7_,const_1605);
         return _loc5_;
      }
