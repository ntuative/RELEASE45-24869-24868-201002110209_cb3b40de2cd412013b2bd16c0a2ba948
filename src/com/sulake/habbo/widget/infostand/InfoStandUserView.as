package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_930:TagListRenderer;
      ...
      private var var_103:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_930 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_200.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_200.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_200.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_200.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_103.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_103.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_103.x = _loc5_.left - 0;
         var_103.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_930.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_103 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_103 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_103.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_103.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_103.x = _loc7_.left - 0;
         var_103.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
