package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1407:Number = 10;
      
      private static const const_1406:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_991,var_990,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_991,var_990,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_1213 = param1.userX;
         var_184 = param1.userImage;
         var_989 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_76,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1214)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_99:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_79:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_236:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_213:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_184 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_184.height);
         }
         ...
         if(var_184 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_184.width;
               _loc28_.height = var_184.height;
               _loc28_.bitmap = new BitmapData(var_184.width,var_184.height,true,0);
               _loc28_.bitmap.copyPixels(var_184,var_184.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_392 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_184.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_989 != 0)
            {
               _loc30_ = uint(var_989 >> 16 & 255);
               _loc31_ = uint(var_989 >> 8 & 255);
               _loc32_ = uint(var_989 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1214 == RoomWidgetChatUpdateEvent.const_236)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_802);
            }
            else if(var_1214 == RoomWidgetChatUpdateEvent.const_213)
            {
      ...
      {
         _widget.onItemMouseDown(var_991,var_990,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_991,var_990,_roomId,_roomCategory,param1);
      }
