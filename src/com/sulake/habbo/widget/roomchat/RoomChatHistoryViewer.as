package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_472:int = 20;
      ...
      private var var_144:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         _isDisposed = false;
         _widget = param1;
         var_144 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         var_144.state = RoomChatHistoryPulldown.const_190;
         ...
         var_36 = param2.createWindow("chatscroller","",HabboWindowType.const_921,HabboWindowStyle.const_23,0 | 0,new Rectangle(param3.rectangle.right - const_472,param3.y,const_472,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_291 ? Number(const_472) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_220 > 0 && param2)
         {
            if(var_1276)
            {
               if(Math.abs(param1 - var_220) <= const_802)
               {
                  return;
               }
               var_1276 = false;
            ...
            if(var_291)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_36.scrollV < 1 - const_1086 / var_36.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1516)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_291 && !var_1140)
         {
            ...
            var_144.state = RoomChatHistoryPulldown.const_281;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_144.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_190);
      }
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(var_36 != null)
         {
            ...
            if(param2)
            {
               var_36.scrollV = var_336;
            }
         }
         if(var_144 != null)
         {
            var_144.containerResized(param1);
         }
      }
