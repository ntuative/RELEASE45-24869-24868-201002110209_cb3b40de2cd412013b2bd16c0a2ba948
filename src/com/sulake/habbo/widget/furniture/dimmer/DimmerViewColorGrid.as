package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_492:BitmapData;
      
      private var var_1282:XML;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_403.destroyGridItems();
         var_286 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1282) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_492.width;
            _loc3_.height = var_492.height;
            var_403.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_492.width,var_492.height,true,0);
               _loc4_.bitmap.copyPixels(var_492,var_492.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_686.width,var_686.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_686,var_686.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_403.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_403.numGridItems)
         {
            return;
         }
         select(var_403.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_686 = BitmapData(_loc3_.content);
      }
