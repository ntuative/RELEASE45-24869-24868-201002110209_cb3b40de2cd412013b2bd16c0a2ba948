package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_38,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1004,const_1003,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_323 != null)
         {
            var_323.setValue(var_982);
         }
         var_399 = colors.indexOf(_loc2_.color);
         if(var_463 != null)
         {
            var_463.setSelectedColorIndex(var_399);
         }
