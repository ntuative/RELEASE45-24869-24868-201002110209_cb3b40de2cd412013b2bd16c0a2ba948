package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1988 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1987 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_659 = new Timer(1000,1);
         var_659.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_812 = new Timer(5000,1);
         var_812.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window.addEventListener(WindowEvent.const_419,onWindowMoved);
         var_1227 = true;
         var_126 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1989 = _loc2_.width + const_473 + _loc6_.width + const_1065;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1066,_loc8_.width) + const_473);
            _loc8_.x = _loc12_;
