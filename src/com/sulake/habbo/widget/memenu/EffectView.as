package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_768:IWindow;
      
      private var var_770:IWindow;
      ...
      {
         super();
         var_160 = new Timer(1000);
         var_160.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_770 = _window.findChildByName("effect_hilite");
            var_770.visible = false;
         }
         var_769 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_768 = _window.findChildByName("loader_bar");
         if(var_768 != null)
         {
            var_388 = var_768.width;
            var_160.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_160.stop();
            var_160.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_160 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_769 != null)
         {
            var_769.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_769.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
