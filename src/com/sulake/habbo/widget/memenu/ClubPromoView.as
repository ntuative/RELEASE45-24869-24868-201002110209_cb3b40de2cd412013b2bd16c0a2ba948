package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_438:String = "CPV_MODE_TRIAL";
      
      public static const const_1260:String = "CPV_MODE_FULL";
      ...
      private const const_1046:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1046,_loc7_,"image/png");
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1046))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1046) as BitmapDataAsset;
            if(!_loc2_)
            {
               return false;
            }
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_696,_loc2_.text,var_617 == const_438);
