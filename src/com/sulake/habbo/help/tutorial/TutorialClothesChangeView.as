package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_41.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_28,onShowMenuEvent);
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_28)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_41.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_385));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_526 = var_41.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_526.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_41.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.MEMENU_ARROW,var_526));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_41.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_28,onShowMenuEvent);
      }
   }
}
