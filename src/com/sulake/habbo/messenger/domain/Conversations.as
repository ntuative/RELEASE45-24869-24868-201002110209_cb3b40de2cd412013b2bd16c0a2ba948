package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1159:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_499,0,var_379.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         return new Message(Message.const_617,0,getOnlineText(param1),Util.getFormattedNow());
      }
