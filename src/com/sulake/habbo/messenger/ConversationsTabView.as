package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         _loc3_.bitmap = var_122.getButtonImage("convo_bg");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = var_122.conversations.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < getTabCount())
         {
            refreshTabContent(_loc2_,_loc1_[var_122.conversations.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         return var_122.conversations.startIndex > 0;
      }
      
      private function refreshTabBg(param1:IWindowContainer, param2:int, param3:String) : void
      {
         var_122.refreshButton(param1,param3,true,onTabClick,param2);
      }
      
      public function getTabCount() : int
      {
         return Math.floor(0 / var_1174);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            var_122.conversations.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_140 ? var_122.conversations.findConversation(param2.id) : var_122.conversations.openConversations[_loc3_ + var_122.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            var_122.conversations.setSelected(_loc4_);
         }
      ...
      {
         var_122.refreshButton(param1,!!param3 ? "next" : "prev",true,null,0);
      }
      ...
      private function refreshFigure(param1:IWindowContainer, param2:String) : void
      {
         ...
         {
            _loc3_.bitmap = var_122.getAvatarFaceBitmap(param2);
            _loc3_.visible = true;
         }
      }
      ...
      {
         return var_122.conversations.openConversations.length - var_122.conversations.startIndex > getTabCount();
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = 0 % var_1174;
         _loc3_.width = var_1174 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = IWindowContainer(var_122.getXmlWindow("tab_entry"));
            _loc3_.y = 1;
         ...
         _loc3_.x = param1 * var_1174;
         _loc3_.width = var_1174;
         return false;
      }
   }
}
