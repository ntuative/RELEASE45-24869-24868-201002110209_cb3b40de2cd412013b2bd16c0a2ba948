package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1497:IMessageComposer;
      ...
      {
         var_791 = IWindowContainer(var_41.getXmlWindow("chatlog_roomheader"));
         var_792 = IWindowContainer(var_41.getXmlWindow("chatlog_chatline"));
         var_462 = new Timer(300,1);
         var_462.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_46 = IFrameWindow(var_41.getXmlWindow("chatlog_frame"));
         var_42 = IItemListWindow(var_46.findChildByName("chatline_list"));
         var_46.procedure = onWindow;
         var _loc1_:IWindow = var_46.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_41.connection.send(var_1497);
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         if(param1.roomId > 0)
         {
            ...
            new OpenRoomTool(var_46,var_41,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_792.clone());
         _loc4_.color = var_1187[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_46,var_41,_loc6_,param2.chatterId);
         }
