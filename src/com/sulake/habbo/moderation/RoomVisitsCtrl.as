package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2024:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2024.clone());
         ...
         new OpenRoomTool(var_46,var_41,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_2024 = IWindowContainer(var_41.getXmlWindow("roomvisits_row"));
         ...
         var_46 = IFrameWindow(var_41.getXmlWindow("roomvisits_frame"));
         var_42 = IItemListWindow(var_46.findChildByName("visits_list"));
