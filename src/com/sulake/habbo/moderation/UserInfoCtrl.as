package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_730:int = 31536000;
      
      private static const const_728:int = 86400;
      
      private static const const_731:int = 3600;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_731)
         {
            return Math.round(param1 / const_729) + " mins ago";
         }
         if(param1 < 2 * const_728)
         {
            return Math.round(param1 / const_731) + " hours ago";
         }
         if(param1 < 2 * const_730)
         {
            return Math.round(param1 / const_728) + " days ago";
         }
         return Math.round(param1 / const_730) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_41,WindowTracker.const_834,_data.userId),_callerFrame,var_933,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_739.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_41.getXmlWindow("user_info"));
            var_739.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ModActionCtrl(var_41,_data.userId,_data.userName,var_1312),_callerFrame,var_933,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new RoomVisitsCtrl(var_41,_data.userId),_callerFrame,var_933,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new SendMsgsCtrl(var_41,_data.userId,_data.userName,var_1312),_callerFrame,var_933,false,true);
      }
