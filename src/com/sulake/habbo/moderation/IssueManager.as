package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_965:String = "issue_bundle_open";
      
      public static const const_628:String = "issue_bundle_my";
      
      public static const const_836:String = "issue_bundle_picked";
      ...
      private var var_512:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_112 = new Map();
         var_728 = new Map();
         var_512 = new IssueBrowser(this,var_49.windowManager,var_49.assets);
         var_609 = [];
         var_729 = [];
         var_904 = new Map();
      }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = var_49.sessionDataManager.userId;
         for each(_loc4_ in var_112)
         {
            switch(param1)
            {
               case const_965:
      ...
      {
         var _loc2_:IssueBundle = var_112.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_609 = var_609.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_728.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = var_112.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     var_112.remove(_loc3_.id);
                     removeHandler(_loc3_.id);
                  }
                  var_728.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1236)
         {
            var_139.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_112)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_728.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_728.add(param1.issueId,_loc2_);
            var_112.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_609.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_133)
         {
            _loc5_ = getBundles(const_628);
            _loc6_ = false;
            ...
            _loc8_ = var_729.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(var_49,_loc2_);
         var_904.remove(param1);
         var_904.add(param1,_loc3_);
         var_49.windowTracker.show(_loc3_,null,false,false,false);
         var_609 = [];
      }
      
      private function sendClose(param1:Array, param2:int) : void
      {
         if(param1 == null || var_49 == null || true)
         {
            return;
         }
         var_49.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array) : void
      {
         ...
         var_49.connection.send(new PickIssuesMessageComposer(param1));
      }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = var_49.sessionDataManager.userId;
         var _loc2_:* = [];
      ...
      {
         if(param1 == null || param1.length == 0 || var_49 == null || true)
         {
            return;
         }
         var_49.connection.send(new ReleaseIssuesMessageComposer(param1));
         var_729 = var_729.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_112.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updatePriorities() : void
      {
         ...
         var _loc3_:int = parseInt(var_49.configuration.getKey("chf.score.updatefactor","60"));
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_112.method_1();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_49.soundManager.playSound(HabboSoundTypesEnum.const_801);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_728.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_112.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_112.method_1();
         var _loc4_:int = var_49.sessionDataManager.userId;
