package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1617:String = "open_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_332.view.width = var_219.container.width;
         var_332.view.height = var_219.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1616:
               if(var_1492 == null)
               {
                  var_1492 = new MyIssuesView(issueManager,this,var_219.container);
               }
               return var_1492;
            case const_1617:
               if(var_1493 == null)
               {
                  var_1493 = new OpenIssuesView(issueManager,this,var_219.container);
               }
               return var_1493;
            case const_1618:
               if(var_1494 == null)
               {
                  var_1494 = new PickedIssuesView(issueManager,this,var_219.container);
               }
               return var_1494;
            default:
               return null;
