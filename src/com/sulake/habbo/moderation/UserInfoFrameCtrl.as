package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_720:UserInfoCtrl;
      ...
      {
         return WindowTracker.const_1241;
      }
      ...
      {
         var_46 = IFrameWindow(var_41.getXmlWindow("user_info_frame"));
         var_46.caption = "User Info";
         var _loc1_:IWindow = var_46.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_720 = new UserInfoCtrl(var_46,var_41,"",true);
         var_720.load(var_46.content,_userId);
         var_46.visible = true;
      }
