package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new RoomToolCtrl(var_41,_roomId),var_46,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1182 ? 0 : 1,_roomId),var_41,WindowTracker.const_516,_roomId),var_46,false,false,true);
      }
      ...
      public function show() : void
      {
         if(var_46 == null)
         {
            var_46 = IFrameWindow(var_41.getXmlWindow("start_panel"));
            ...
            var_41.disableButton(var_41.initMsg.cfhPermission,var_46,"ticket_queue_but");
