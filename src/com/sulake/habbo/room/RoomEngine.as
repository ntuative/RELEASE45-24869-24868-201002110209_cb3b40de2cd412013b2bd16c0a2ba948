package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_470:String = "room";
      
      private static const const_739:int = -2;
      
      private static const const_469:String = "temporary_room";
      ...
      private var var_555:NumberBank;
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_57 != null)
         {
            ...
            {
               return var_57.deleteWallItem(var_106,var_107,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_283.length; _loc2_++)
         {
            _loc3_ = var_283.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_642) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_606) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_531) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_115);
            if(_loc7_ != null)
            {
      ...
      public function method_11(param1:int, param2:int, param3:int, param4:int) : void
      {
         if(var_57 == null)
         {
            return;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_57 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_12)
            {
               return var_57.modifyWallItemData(var_106,var_107,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_283 != null)
         {
            ...
            {
               _loc2_ = var_283.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_937;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_570);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_592);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_657);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_932);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_843);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               ...
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_772);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_496,var_106,var_107,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_57 != null)
         {
            return var_57.modifyRoomObject(var_106,var_107,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_693,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_553,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_538,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_33 != null)
         {
            var_33.addObjectUpdateCategory(RoomObjectCategoryEnum.const_15);
            ...
            var_33.addObjectUpdateCategory(RoomObjectCategoryEnum.const_246);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_57 != null)
         {
            var_57.handleRoomObjectEvent(param1,var_106,var_107);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_859,1,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_245,param1,param2,param3,RoomObjectCategoryEnum.const_15));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_497,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(_roomObjectFactory == null || var_411 == null || var_33 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_1901)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_33.getRoom(getRoomIdentifier(var_106,var_107));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_106,var_107,var_1190);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_106,var_107,var_1190);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_411;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_199,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_396,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_369,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_243,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_557,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_72,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_463,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_216,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_358,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_343,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_986,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_379,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_348,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_106,var_107);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_662) != 0)
         {
            return false;
         }
         if(var_57 != null)
         {
            return var_57.initializeRoomObjectInsert(var_106,var_107,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_245,param1,param2,param3,RoomObjectCategoryEnum.const_19));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_12:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_459);
                     break;
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_937,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_245,param1,param2,param3,RoomObjectCategoryEnum.const_12));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_427.events.addEventListener(AdEvent.const_391,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_283.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_464 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_33.getRoom(const_469);
         if(_loc10_ == null)
         {
            _loc10_ = var_33.createRoom(const_469,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_555.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_459,param8);
               break;
            case RoomObjectCategoryEnum.const_19:
            ...
            case RoomObjectCategoryEnum.const_42:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_226,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_493,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_659,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_528,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_739,RoomObjectCategoryEnum.const_246);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_106,var_107,param1);
         if(_loc9_ != null)
         {
            var_1190 = param1;
            var_1441 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1441 - _loc12_.width / 2;
               _loc11_.y = var_1442 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_351,var_106,var_107,-1,RoomObjectCategoryEnum.const_182));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_57 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_260,const_470);
                  var_57.handleRoomObjectEvent(_loc14_,var_106,var_107);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_106,var_107,param1,param2,new Vector3d(),1,null);
         }
         else if(var_9 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_106,var_107,var_1190);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_259);
            _loc11_ = addOverlayIconSprite(_loc10_,const_259,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1441 - _loc6_.data.width / 2;
               _loc11_.y = var_1442 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_301,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_912,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_806,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_790,RoomObjectVariableEnum.const_301,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_283.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_57 != null)
         {
            var_57.cancelRoomObjectInsert(var_106,var_107);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_33.getRoom(const_469);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return getRoomObjectBoundingRectangle(var_106,var_107,const_260,RoomObjectCategoryEnum.const_42,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_662,1,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_260,const_470,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_662,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_570,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_642,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_531,_loc17_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_891,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_693,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_553,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_538,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_455,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_191);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_592,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_657,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_592,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_657,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_932,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_843,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_739,const_1054,RoomObjectCategoryEnum.const_246);
         _loc7_.createRoomObject(const_741,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_246);
         return _loc7_;
      }
