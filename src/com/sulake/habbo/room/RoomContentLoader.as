package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_725:String = "selection_arrow";
      
      private static const const_727:String = "tile_cursor";
      
      private static const const_258:String = "RCL_PUBLICROOM_";
      
      private static const const_466:String = "wall_place_holder";
      
      private static const const_1022:int = 2;
      
      private static const const_322:String = "place_holder";
      
      private static const const_1023:String = const_322;
      
      private static const const_1387:int = 0;
      
      private static const const_726:int = 1;
      ...
      public function RoomContentLoader()
      {
         var_425 = [];
         _wallItems = [];
         var_1648 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1651 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_360 = new Map();
         _events = new Map();
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_94 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_359 != null)
         {
            _loc2_ = var_359.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_426.add(_loc10_,_loc11_);
                              if(var_425.indexOf(_loc14_) < 0)
                              {
                                 var_425.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_360 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_360.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_310 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_310.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_360.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_360.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_322,const_466,ROOM_CONTENT,const_727,const_725];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1648.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_141 && _loc5_ != RoomObjectLogicEnum.const_94)
         {
            _loc6_ = "@shadow";
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_524.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1364);
               return;
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1647)
         {
            ...
            if(var_928 != null)
            {
               var_928.dispatchEvent(new Event(const_608));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_928 = param1;
            var_1649 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1652 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1650 = param2.getKey("public.room.dynamic.download.url","");
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_310.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_358 != null)
         {
            var_358.remove(param1);
            var_358.add(param1,param2);
         }
         if(var_359 != null)
         {
            var_359.remove(param2);
            var_359.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_141 && _loc5_ != RoomObjectVisualizationEnum.const_94)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1114.getValue(param1) != null)
         {
            var_156 = var_1114.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_404,onContentLoaded);
            _loc6_ = 0;
