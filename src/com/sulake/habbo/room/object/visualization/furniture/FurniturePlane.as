   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2203)
         {
            if(!param1)
            {
               var_266.assign(var_586);
               var_265.assign(var_585);
            }
            else
            {
               var_266.assign(var_586);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_62 == null && var_853 != null || var_266 == null || var_265 == null || var_495 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1306)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1045 || _loc4_.y != var_1727 || _loc4_.z != var_1726 || param1.scale != var_1725))
            {
               var_1045 = _loc4_.x;
               var_1727 = _loc4_.y;
               var_1726 = _loc4_.z;
