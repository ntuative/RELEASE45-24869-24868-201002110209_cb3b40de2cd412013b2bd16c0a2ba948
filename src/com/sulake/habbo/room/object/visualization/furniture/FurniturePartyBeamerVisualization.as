package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_721:int = 15;
      
      private static const const_1014:int = 2;
      
      private static const const_329:int = 2;
      
      private static const const_722:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         if(int(_loc9_) == 0)
         {
            var_915[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_918.push(-1);
         var_916 = new Array();
         var_916.push(const_1014);
         var_916.push(const_1013);
         var_915 = new Array();
         var_915.push(getRandomAmplitudeFactor());
         var_915.push(getRandomAmplitudeFactor());
      }
