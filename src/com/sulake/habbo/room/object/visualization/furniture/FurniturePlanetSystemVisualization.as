package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_872);
      ...
      {
         if(param1 < var_547.length)
         {
            return var_547[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_209 != null)
         {
            ...
            {
               _loc2_ = var_209[_loc3_];
               _loc2_.update(var_547,var_1845,param1);
               _loc3_++;
            }
