package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_292:int = 1000;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1291 / 2) % 360 / var_1291;
         ...
         {
            _loc6_ = int(var_226.getKey(_loc5_)) * var_1291;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_893);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_944);
                  break;
               case "DARKEN":
      ...
      public function method_16(param1:XML) : Boolean
      {
         if(param1 == null)
         {
            return false;
