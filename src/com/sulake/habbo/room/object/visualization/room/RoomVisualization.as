package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1135:int = 13421772;
      
      private static const const_1040:int = 16777215;
      
      public static const const_1359:int = 10066329;
      
      private static const const_1039:int = 13421772;
      
      public static const const_1276:int = 16777215;
      
      private static const const_1397:int = 0;
      
      public static const const_1110:int = 16777215;
      ...
      private var var_1148:String = null;
      ...
      private var var_1147:String = null;
      
      private var var_1729:int = -1000;
      
      private var var_948:uint = 16777215;
      ...
      private var var_529:Rectangle = null;
      ...
      private const const_1599:int = 250;
      
      private var var_68:RoomPlaneParser = null;
      ...
      private var var_372:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_68 = new RoomPlaneParser();
         var_372 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_68.planeCount)
         {
            _loc3_ = var_68.getPlaneType(_loc2_);
            if(_loc3_ == RoomPlaneData.const_226)
            {
               _loc4_ = var_68.getPlaneRightSide(_loc2_);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_928);
         if(!var_68.initializeFromXML(new XML(_loc2_)))
         {
            return;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_891);
         var _loc7_:int = 0;
         while(_loc7_ < var_68.planeCount)
         {
            _loc8_ = var_68.getPlaneLocation(_loc7_);
            _loc9_ = var_68.getPlaneLeftSide(_loc7_);
            _loc10_ = var_68.getPlaneRightSide(_loc7_);
            _loc11_ = var_68.getPlaneSecondaryNormals(_loc7_);
            _loc12_ = var_68.getPlaneType(_loc7_);
            _loc13_ = null;
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_169,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_226)
            {
            ...
            if(_loc13_ != null)
            {
               ...
               _loc15_ = 0;
               while(_loc15_ < var_68.getPlaneMaskCount(_loc7_))
               {
                  _loc16_ = var_68.getPlaneMaskLeftSideLoc(_loc7_,_loc15_);
                  _loc17_ = var_68.getPlaneMaskRightSideLoc(_loc7_,_loc15_);
                  _loc18_ = var_68.getPlaneMaskLeftSideLength(_loc7_,_loc15_);
                  _loc19_ = var_68.getPlaneMaskRightSideLength(_loc7_,_loc15_);
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_529 == null)
         {
            var_529 = super.boundingRectangle;
         }
         return new Rectangle(var_529.x,var_529.y,var_529.width,var_529.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_372.maskCount)
         {
            _loc6_ = var_372.getMaskType(_loc5_);
            _loc7_ = var_372.getMaskLocation(_loc5_);
            _loc8_ = var_372.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_94.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_254 || _loc3_.type == RoomPlane.const_168 && _loc8_ == RoomPlaneBitmapMaskData.const_191)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1355;
                        if(var_68.getPlaneType(_loc9_) == RoomPlaneData.const_128)
                        {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_68.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_226)
            {
               _loc4_ = var_68.getPlaneLeftSide(_loc2_);
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1306)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1045 || _loc9_.y != var_1727 || _loc9_.z != var_1726 || param1.scale != var_1725))
            {
               var_1045 = _loc9_.x;
               var_1727 = _loc9_.y;
               var_1726 = _loc9_.z;
               var_1725 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         if(var_150 != _loc6_.getUpdateID())
         {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_639));
            if(_loc11_ != var_948)
            {
               var_948 = _loc11_;
               var_1732 = var_948 & 255;
               var_1730 = var_948 >> 8 & 255;
               var_1728 = var_948 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1729 + const_1599 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1729 = _loc7_;
         if(var_150 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_659);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_493);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_528);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1733 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_839));
            var_150 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_371.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_371[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_168)
            {
               if(var_1733)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1732 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1730 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1728 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_94.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_169 && param1 != null)
               {
                  _loc5_.id = param1;
               }
