package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1321:int = const_300;
      ...
      public static const const_178:int = 4;
      
      public static const const_546:int = 6;
      
      public static const const_250:int = const_85;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1397 == const_85)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_439);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_439,var_23.width,var_439);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_753,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_439,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
