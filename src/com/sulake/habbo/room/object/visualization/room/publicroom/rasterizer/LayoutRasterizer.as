package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_956:Point = null;
      
      private var var_451:Array;
      
      private var var_957:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_958 = param1;
         var _loc3_:LayoutRasterizerData = var_55.getValue(var_632);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1155 = RoomObjectVariableEnum.const_912;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1155 = RoomObjectVariableEnum.const_806;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_958 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_958 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_958 + _adBgIndex);
            _loc5_ = param1.getSprite(var_958 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1155);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_367;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1813);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         if(var_55 != null)
         {
            ...
            {
               _loc2_ = var_55.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_632)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_957 = var_55.getValue(var_632);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_55.getValue(var_632);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_957.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_956.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_956.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_315.indexOf(_loc10_) >= 0 && var_453)
            {
               param1 = var_315.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_452[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
