package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1515:int = 16777216;
      ...
      private var var_1384:int = 16777216;
      ...
      public function set name_2(param1:int) : void
      {
         if(param1 < 1)
         {
            param1 = 1;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1384 * param2);
      }
      ...
      {
         var _loc1_:int = var_2315 * var_1121 + var_2314;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
