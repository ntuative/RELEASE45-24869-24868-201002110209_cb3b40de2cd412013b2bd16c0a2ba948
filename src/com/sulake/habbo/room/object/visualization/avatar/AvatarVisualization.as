package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1405:int = 0;
      
      private var var_576:String;
      
      private var var_597:int = 0;
      
      private const const_1597:int = 1;
      ...
      private const const_1056:int = 3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_365.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_629);
         ...
         var _loc14_:Number = _loc8_ - var_1199;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_271);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_269 != _loc3_.getUpdateID() || var_197 != param1.scale || var_150 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_466 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_466;
            _loc23_ = getTimer();
            if(var_576 != _loc7_)
            {
               for each(_loc49_ in var_365.getKeys())
               {
                  var_365.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_749.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_365.remove(_loc5_);
               var_365.add(_loc5_,_loc6_);
               var_576 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_283);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_229) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_229);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_484);
            _loc6_.appendAction(AvatarAction.const_571,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_332);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_33)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_423);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_275,AvatarAction.const_1297[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_972);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_764,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_828);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_852);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_821,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_664);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_621);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_778,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_822);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_916,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_374);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_394) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_486);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_400);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_917);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_700,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_808))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_749.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_750.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_750)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_365 != null)
         {
            _loc1_ = var_365.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_365.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
