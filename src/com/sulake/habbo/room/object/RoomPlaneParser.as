package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_941;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_226,param1,param2,param3,[param4]);
      ...
      {
         if(param1 == null || var_95 == null || param1 == var_95)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > var_95.length)
         {
            return false;
         }
      ...
      private function getTileHeightInternal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = var_95[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(var_95);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < var_95.length)
         {
            _loc4_ = var_95[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_320 || param1 == var_318)
               {
                  _loc5_ = false;
                  _loc6_ = var_319;
               ...
               if(param2 == var_319 || param2 == var_317)
               {
                  _loc7_ = false;
                  _loc8_ = var_320;
