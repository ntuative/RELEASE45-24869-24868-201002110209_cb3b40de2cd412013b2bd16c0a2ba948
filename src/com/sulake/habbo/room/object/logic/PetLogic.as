         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1343,_loc4_.race);
               }
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_271,new Date().valueOf());
                  }
                  else
                  {
               ...
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_332,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_423,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_229,_loc10_.postureType);
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_992,Number(getTimer()));
