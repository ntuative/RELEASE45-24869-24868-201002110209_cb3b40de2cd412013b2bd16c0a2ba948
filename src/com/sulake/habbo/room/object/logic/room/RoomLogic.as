package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1425:int = 1500;
      
      private var var_1426:int = 255;
      
      private var var_1427:int = 255;
      
      private var var_1171:uint = 16777215;
      
      private var var_965:uint = 16777215;
      
      protected var var_68:RoomPlaneParser = null;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_693:
                  _loc2_.setString(RoomObjectVariableEnum.const_493,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_553:
                  _loc2_.setString(RoomObjectVariableEnum.const_659,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_455:
                  ...
                  var_372.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_517:
                  _loc7_ = var_372.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_372.getXML();
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_839,int(_loc5_.bgOnly));
            var_1171 = _color;
            var_1426 = var_1232;
            var_965 = _loc11_;
            var_1427 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_68.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_928,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_639,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_68.planeCount)
         {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_68.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_68.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_68.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_68.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_68.getPlaneNormal(_loc5_);
         var _loc13_:int = var_68.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1330,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1250,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1255,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_119 || _loc13_ == RoomPlaneData.const_226)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_775)
         {
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_639,_loc3_);
         }
      }
   }
}
