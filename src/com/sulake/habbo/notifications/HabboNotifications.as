package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1036:String = "badges";
      
      private static const const_1032:String = "pixelbalance";
      
      private static const const_1034:String = "credits";
      
      private static const const_1033:String = "inventory";
      
      private static const const_1030:String = "friendlist";
      
      private static const const_1035:String = "selectfurni";
      ...
      private var var_1139:IHabboToolbar;
      ...
      private var var_626:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_756);
         }
         var _loc6_:Map = var_756["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1189);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_626 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,var_75);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc2_,NotificationType.const_1267);
      }
      ...
      {
         if(param2.type == WindowEvent.const_145 || param2.type == WindowEvent.const_580)
         {
            param1.dispose();
         }
      }
      ...
      {
         var _loc1_:Array = var_947.splice(0,1);
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_565);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc16_ = var_565.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_57)
               {
                  _loc16_ = var_565.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_565.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_907,_loc5_);
         }
      ...
      {
         var_1139 = IHabboToolbar(param2);
         var_1139.events.addEventListener(HabboToolbarEvent.const_65,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_565.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_952);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_952);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_266;
            }
            if(param2 == 4057)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_65)
         {
            ...
            var_370 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_756["styles"],var_756["view"],var_1139);
            ...
            var_565.events.addEventListener(BadgeImageReadyEvent.const_88,onBadgeImage);
            var_1139.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
