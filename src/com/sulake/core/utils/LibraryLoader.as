package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1372:uint = 2;
      
      protected static const const_1370:uint = 1;
      
      protected static const const_1371:int = 5;
      
      protected static const const_1022:uint = 7;
      
      protected static const const_1373:uint = 4;
      
      protected static const const_1374:uint = 3;
       
      
      protected var var_890:int;
      
      protected var var_2252:String = "";
      
      protected var var_350:int;
      
      protected var var_460:XML;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_460 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_414 == LibraryLoader.const_1374)
         {
            if(analyzeLibrary())
            {
               var_414 |= 0;
         ...
         if(var_414 == LibraryLoader.const_1022)
         {
            var_1334 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_890 > 0)
            {
               var_14.close();
               var_14.unload();
               addRequestCounterToUrlRequest(var_301,const_1371 - var_890);
               var_14.load(var_301,_context);
               --var_890;
               return true;
            }
