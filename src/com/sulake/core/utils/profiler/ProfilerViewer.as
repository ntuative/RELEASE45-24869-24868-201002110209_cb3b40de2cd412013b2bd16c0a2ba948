package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerViewer extends TextField implements IDisposable
   {
      ...
      {
         text += padAlign(String(param1.name),30) + "|" + padAlign(String(param1.rounds),10) + "|" + padAlign(String(param1.latest),10) + "|" + padAlign(String(param1.average),10) + "|" + padAlign(String(param1.method_14),10) + "|\r";
         var _loc3_:int = 0;
