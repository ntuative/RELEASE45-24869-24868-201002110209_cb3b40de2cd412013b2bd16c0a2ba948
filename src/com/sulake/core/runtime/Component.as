package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1564:uint = 1;
      ...
      protected var var_361:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1887:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_884 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_884);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1065 & const_811)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_361 + "]";
      }
   }
}
