package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1496,var_2038);
         var_1254 = new Dictionary();
         var_2037 = new Dictionary();
         StateCodeTable.fillTables(var_1254,var_2037);
         var_478 = new Dictionary();
         var_478["skin"] = BitmapSkinRenderer;
         var_478["bitmap"] = BitmapDataRenderer;
         var_478["fill"] = FillSkinRenderer;
         var_478["text"] = TextSkinRenderer;
         var_478["shape"] = ShapeSkinRenderer;
         var_478["unknown"] = SkinRenderer;
         var_478["null"] = NullSkinRenderer;
         if(var_352 == null)
         {
            var_352 = new Array();
            var_352.push(WindowState.const_44);
            var_352.push(WindowState.const_51);
            var_352.push(WindowState.const_76);
            var_352.push(WindowState.const_29);
            var_352.push(WindowState.const_59);
            var_352.push(WindowState.const_52);
            var_352.push(WindowState.const_70);
            var_352.push(WindowState.const_61);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1254)
         {
            _loc3_.push(var_1254[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1496[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_569[param1] = new Array(SkinContainer.const_1073);
         }
