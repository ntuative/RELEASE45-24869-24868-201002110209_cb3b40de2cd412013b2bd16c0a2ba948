package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1573:String = "_INCLUDE";
      
      public static const const_958:String = "_EXCLUDE";
      
      public static const const_1562:String = "_TEMP";
      ...
      protected var var_891:Dictionary;
      
      protected var var_1335:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1336:Dictionary;
      
      protected var var_1063:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1063,var_1064);
         var_891 = new Dictionary();
         var_1336 = new Dictionary();
         ParamCodeTable.fillTables(var_891,var_1336);
         var_1335 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1063)
            {
               delete var_1063[_loc1_];
            }
            for(_loc1_ in var_1064)
            {
               delete var_1064[_loc1_];
            }
            for(_loc1_ in var_891)
            {
               delete var_891[_loc1_];
            }
            for(_loc1_ in var_1336)
            {
               delete var_1336[_loc1_];
            }
            var_1335.dispose();
            var_1335 = null;
            _context = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_144)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_958) == -1)
                  {
