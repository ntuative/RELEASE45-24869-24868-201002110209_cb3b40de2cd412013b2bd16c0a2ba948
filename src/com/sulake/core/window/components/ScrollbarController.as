package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1044:String = "increment";
      
      private static const const_468:String = "slider_bar";
      
      private static const const_1045:String = "decrement";
      
      private static const const_732:String = "slider_track";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_468:
      ...
      {
         return findChildByName(ScrollbarController.const_732) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_468) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_760 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_760 != null)
         {
            _loc1_ = findParentByName(var_760) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_760) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1044)
            {
               if(var_19)
               {
                  var_533 = true;
            ...
            else if(param2.name == ScrollbarController.const_732)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_468).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_815)
         {
