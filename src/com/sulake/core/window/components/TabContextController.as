package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1084:String = "content";
      
      private static const const_1083:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1563 == null)
         {
            var_1563 = findChildByTag(TabContextController.const_1084) as IWindowContainer;
         }
         return var_1563;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_893 == null)
         {
            var_893 = findChildByTag(TabContextController.const_1083) as ITabSelectorWindow;
            if(var_893 != null)
            {
