package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_735:String = "margin_top";
      
      private static const const_1053:String = "_HEADER";
      
      private static const const_736:String = "margin_right";
      
      private static const const_1050:String = "_SCALER";
      
      private static const const_1052:String = "_TITLE";
      
      private static const const_1051:String = "_CONTENT";
      
      private static const const_737:String = "margin_left";
      ...
      private var var_1181:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_737,_loc3_.left,PropertyStruct.const_46,_loc2_));
         _loc1_.push(new PropertyStruct(const_735,_loc3_.top,PropertyStruct.const_46,_loc2_));
         _loc1_.push(new PropertyStruct(const_736,0 - _loc3_.right,PropertyStruct.const_46,_loc2_));
         _loc1_.push(new PropertyStruct(const_738,0 - _loc3_.bottom,PropertyStruct.const_46,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_220);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1181 == null)
         {
            var_1181 = findChildByTag(const_1053) as IHeaderWindow;
            if(!var_1181)
            {
      ...
      {
         return content != null && var_1334 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_17 == null)
         {
            var_17 = findChildByTag(const_1051) as IWindowContainer;
            if(!var_17)
            {
