package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1369:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_413 = new Array();
         var_413[0] = MouseCursorType.const_312;
         var_413[1] = MouseCursorType.const_20;
         var_413[2] = MouseCursorType.const_312;
         var_413[3] = MouseCursorType.const_312;
         var_413[4] = MouseCursorType.const_20;
         var_413[5] = MouseCursorType.const_20;
         var_413[6] = MouseCursorType.const_312;
         if(var_304 == null)
         {
            var_304 = new Array();
            var_304[0] = WindowState.const_70;
            var_304[1] = WindowState.const_52;
            var_304[2] = WindowState.const_59;
            var_304[3] = WindowState.const_44;
            var_304[4] = WindowState.const_29;
            var_304[5] = WindowState.const_76;
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_940,param1.toolTipDelay != const_1369));
         return param2;
      }
      ...
      {
         var_888 = param1 == null ? const_716 : param1;
      }
