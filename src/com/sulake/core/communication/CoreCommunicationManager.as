package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_635[_loc3_];
      ...
      {
         var _loc3_:Array = var_635[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_635[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      {
         if(param1 == null || var_380 == null)
         {
            return null;
         }
         return var_380[param1] as IConnection;
      }
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_380)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_863:
               _loc3_ = new SocketConnection(param1,this,var_1826);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_380[param1] = _loc3_;
         return _loc3_;
      }
