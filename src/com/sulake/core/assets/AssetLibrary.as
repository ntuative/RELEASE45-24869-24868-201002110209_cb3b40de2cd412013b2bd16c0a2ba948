package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_981:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_554:uint = 0;
      
      public static const const_791:String = "AssetLibraryReady";
      
      public static const const_1167:String = "AssetLibraryUnloaded";
      
      public static const const_404:String = "AssetLibraryLoaded";
      
      public static const const_1355:String = "AssetLibraryLoadError";
       
      
      private var var_460:XML;
      
      private var var_384:Dictionary;
      
      private var var_321:Array;
      
      private var var_182:uint;
      ...
      private var var_461:Boolean = true;
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_385)
         {
            _loc2_ = var_385[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_385[_loc1_];
         }
         ...
         var_282 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1167));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_460 = _loc2_.manifest.copy();
         var_322 = _loc2_.resource;
         if(var_461)
         {
            AssetLibrary.fetchLibraryContents(this,var_460,var_322);
         }
         var_282 = true;
         dispatchEvent(new Event(AssetLibrary.const_404));
         dispatchEvent(new Event(AssetLibrary.const_791));
         if(var_461)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_385[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_780,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_981.splice(var_981.indexOf(this),1);
            --var_554;
            var_385 = null;
            var_647 = null;
            _loadedAssets = null;
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_14 == null)
            {
               var_14 = new LibraryLoader(var_1323);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_460.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_385[loader.url];
         if(struct == null)
         {
