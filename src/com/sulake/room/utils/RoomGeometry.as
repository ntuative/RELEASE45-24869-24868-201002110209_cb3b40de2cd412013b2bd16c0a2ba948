package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_807:Number = 32;
      ...
      private var var_2316:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_77 = new Vector3d();
         var_955 = new Vector3d();
         var_1411 = 1;
         var_1412 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1410 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            var_76.assign(_loc23_);
            _y.assign(_loc24_);
            var_77.assign(_loc25_);
         }
         else
         {
            var_76.assign(_loc18_);
            _y.assign(_loc19_);
            var_77.assign(_loc20_);
         }
      }
      
      public function set z_scale(param1:Number) : void
      {
         if(var_376 != param1 * var_1410)
         {
            var_376 = param1 * var_1410;
            ++var_69;
         }
      }
      ...
      {
         if(var_377 != param1 * var_1411)
         {
            var_377 = param1 * var_1411;
            ++var_69;
         }
      }
      ...
      {
         if(var_378 != param1 * var_1412)
         {
            var_378 = param1 * var_1412;
            ++var_69;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_375 != null)
         {
            ...
            var_375.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_375.add(_loc3_,_loc4_);
            ++var_69;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_955.assign(_loc22_);
         }
         else
         {
            var_955.assign(_loc17_);
         }
         ++var_69;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_378;
         _loc2_.z *= var_376;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_955);
         if(_loc3_ < var_2316 || _loc3_ > var_2317)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,var_76);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_378;
            _loc2_.z *= var_376;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_955);
         }
      ...
      {
         return new Vector3d(0 * var_377,0 * var_378,0 * var_376);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.scalarProjection(param1,var_76);
         var _loc3_:Number = Vector3d.scalarProjection(param1,_y);
         var _loc4_:Number = Vector3d.scalarProjection(param1,var_77);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function get directionAxis() : IVector3d
      {
         return new Vector3d(var_77.x,var_77.y,var_77.z);
      }
      
      public function isZoomedIn() : Boolean
      {
         return scale == const_663;
      }
      
      public function get scale() : Number
      {
         return var_189 / Math.sqrt(0.5);
      }
      ...
      public function adjustLocation(param1:IVector3d, param2:Number) : void
      {
         ...
         var _loc3_:Vector3d = Vector3d.product(var_77,param2);
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_375 != null)
         {
            ...
            return var_375.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_189;
         var _loc6_:Number = -param1.y / var_189;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_76,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_377,0 * var_378,0 * var_376);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_77;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_377,param2.y * var_378,param2.z * var_376);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_377,param3.y * var_378,param3.z * var_376);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_377,param4.y * var_378,param4.z * var_376);
