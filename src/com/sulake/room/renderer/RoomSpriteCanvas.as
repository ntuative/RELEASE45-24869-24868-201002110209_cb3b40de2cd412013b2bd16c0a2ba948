package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_756:int = 50;
      ...
      private var var_839:RoomObjectLocationCache;
      ...
      private var var_2114:Number = -10000000;
      
      private var var_2115:Number = -10000000;
      ...
      private var var_1029:IRoomRenderingCanvasMouseListener = null;
      
      private var var_1027:Point;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_44 = new Sprite();
         var_44.name = "canvas";
         var_44.mouseEnabled = false;
         _master.addChild(var_44);
         var_44.mouseEnabled = true;
         var_44.doubleClickEnabled = true;
         var_44.addEventListener(MouseEvent.CLICK,clickHandler);
         var_44.addEventListener(MouseEvent.DOUBLE_CLICK,clickHandler);
         ...
         var_839 = new RoomObjectLocationCache(_loc6_);
         var_293 = new Map();
      ...
      public function update() : void
      {
         if(var_1025 == 0)
         {
            checkMouseHits(var_1027.x,var_1027.y,MouseEvent.MOUSE_MOVE);
         }
         var_1025 = 0;
         ++var_1521;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_1028 = param1;
         var_1026 = param2;
         var_44.graphics.clear();
         var_44.graphics.beginFill(var_2325);
         var_44.graphics.drawRect(0,0,param1,param2);
         var_44.mask = var_255;
      }
      ...
      {
         var _loc11_:Number = param1 - var_1028 / 2;
         var _loc12_:Number = param2 - var_1026 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc6_ < var_292.length)
         {
            var_292.splice(_loc6_);
         }
         var_292.sortOn("z",0 | 0);
         var _loc10_:* = null;
         var _loc11_:int = 0;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc10_ = var_292[_loc5_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         var_683.push(_loc12_ - _loc2_);
         if(var_683.length == const_756)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_756)
            {
               _loc13_ += var_683[_loc14_];
               _loc14_++;
            }
         ...
         while(_loc1_ < var_293.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1029 != null)
                  {
                     var_1029.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1521,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_44.numChildren)
         {
            return null;
         }
         return var_44.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         while(_loc5_ >= param1)
         {
            _loc3_ = var_44.getChildAt(_loc5_);
            _loc6_ = null;
      ...
      {
         if(param1 < 0 || param1 >= var_292.length)
         {
            return null;
         }
         return var_292[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            _loc10_ = var_44.getChildAt(_loc14_) as ExtendedSprite;
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_490.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_490.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2114 || param2 != var_2115)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_490.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_490.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= var_44.numChildren)
         {
            var_44.addChild(_loc3_);
         }
         else
         {
            var_44.addChildAt(_loc3_,param2);
         }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(param1 >= var_44.numChildren)
         {
            createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = var_44.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:int) : int
      {
         ...
         var _loc6_:IVector3d = var_839.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc8_ += int(var_1028 / 2);
         _loc9_ += int(var_1026 / 2);
         ...
         while(_loc18_ < _loc7_)
         {
            ...
            if(_loc13_ != null && _loc13_.visible)
            {
               ...
               if(_loc19_ != null)
               {
                  ...
                  if(_loc14_ + _loc19_.width >= 0 && _loc14_ < var_1028 && (_loc15_ + _loc19_.height >= 0 && _loc15_ < var_1026))
                  {
                     if(_loc11_ < _loc17_)
                     {
                        _loc12_ = var_292[_loc11_];
                     }
                     else
                     {
                        _loc12_ = new SortableSprite();
                        var_292.push(_loc12_);
                     }
