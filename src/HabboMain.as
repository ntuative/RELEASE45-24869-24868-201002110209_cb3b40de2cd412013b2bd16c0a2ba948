package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1137);
      }
      ...
      public function initializeCore() : void
      {
         ...
         {
            Core.crash("Failed to initialize the core: " + error.message,CoreComponent.const_1173,error);
         }
      }
      
      protected function onAddedToStage(param1:Event = null) : void
      {
         trackLoginStep(HabboLoginTrackingStep.const_1134);
